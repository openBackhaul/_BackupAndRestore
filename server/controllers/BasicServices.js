...
const restoreJobWatcher = require('../service/individualServices/RestoreJobWatcher');
...
module.exports.embedYourself = async function embedYourself(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  ...
  await BasicServices.embedYourself(body, user, xCorrelator, traceIndicator, customerJourney, req.url)
    .then(async function (responseBody) {
      kafkaClient.connectToKafka(); // subscribe to kafka
      notificationManagement.subscribeToControllerNotifications(); // subscribe to controller notification
      restoreJobWatcher.init(); // initiate job watcher
